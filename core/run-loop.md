...
- When requirements depend on current implementation, analyst research is bounded to one registered role `code` contour, records the exact commit, and verifies that the code worktree is unchanged.
