...
- Every seed must resolve to an issue in that provider or an evidenced `snapshot-not-found` result. Counterpart links are one-to-one; conflicting or duplicate SberTrek/Jira claims block the report.
