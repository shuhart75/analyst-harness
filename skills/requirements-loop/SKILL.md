...
Validation: individual rules, isolated-reader wording, cross-requirement interactions, delivery readiness, direct `REQ-*` traceability, links, stale-term sweep, Russian-language check, compact-profile check, PlantUML integrity, and explicit coverage of every cross-feature impact.
