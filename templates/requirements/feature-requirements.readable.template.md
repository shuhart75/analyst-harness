...
| Requirement ID | Правило | Связанные срезы |
|---|---|---|
| REQ-<FEATURE>-001 |  |  |
...
- Для каждого обязательного влияния на соседнюю фичу должна существовать строка в разделе `Доработки затронутых фич`.
