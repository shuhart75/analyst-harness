...
mkdir -p "$TARGET/.workflow/modes" "$TARGET/.workflow/overrides" "$TARGET/.workflow/tools" "$TARGET/.workflow/templates/requirements" "$TARGET/.workflow/templates/intake" "$TARGET/.vscode"
