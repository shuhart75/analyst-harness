...
ANALYTICS_SNAPSHOT_REF_PREFIX = "refs/analyst-harness/analytics-snapshots"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(description="Защищённые Git-операции collaboration")
